<template>
  <view class="content">
    ...
    <uni-card class="stadium-card" title="省体育中心" extra="十一人制" mode="style" is-shadow>
      ...
      <template #actions>
        <view class="flex-between">
          <view>
            <uni-icons type="navigate" size="20"></uni-icons>
            <span class="middle">导航</span>
          </view>
          <view>
    ...
    <uni-card class="stadium-card" title="奥体中心内场" extra="十一人制" mode="style" is-shadow>
      <text>(11人制) 榕超联赛由2个组别, 共20个球队组成. </text>
    </uni-card>
    <uni-card class="stadium-card" title="五孔闸球场" extra="八人制" mode="style" is-shadow>
